...
function Export-EntraReportHtml {
    ...
    [void]$html.AppendLine("<title>Entra ID / M365 Report - $(& $esc $Result.TenantId)</title>")
    ...
    [void]$html.AppendLine('<h1>ENTRA ID / M365 REPORT</h1>')
    ...
    [void]$html.AppendLine("<div class=`"subtitle`">$timestampStr | Guerrilla v$moduleVersion</div>")
    ...
    # Footer
    [void]$html.AppendLine("<div class=`"footer`">Generated by Guerrilla v$moduleVersion | Entra ID / M365 Audit | $timestampStr<br>By Jim Tyler, Microsoft MVP | <a href=`"https://github.com/jimrtyler`">GitHub</a> | <a href=`"https://linkedin.com/in/jamestyler`">LinkedIn</a> | <a href=`"https://youtube.com/@jimrtyler`">YouTube</a></div>")
