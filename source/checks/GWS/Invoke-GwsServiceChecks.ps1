...
# state from admin audit-log setting-change events (Get-GWSAuditData ->
...
# itself derives these from Admin audit-log events, which this read-only platform does not
